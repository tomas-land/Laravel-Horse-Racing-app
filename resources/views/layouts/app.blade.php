                ...
                @auth
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ma-auto">
                            ...
                            <li class="nav-item {{ Request::is('betters') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('betters.index') }}">Betters
                                </a>
                            </li>

                            <li class="nav-item {{ Request::is('horses') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('horses.index') }}">Horses</a>
                            </li>
                        </ul>
                    @endauth
